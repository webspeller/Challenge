...
var $author$project$Main$GotRequestCountriesResponse = function (a) {
	return {$: 'GotRequestCountriesResponse', a: a};
};
var $author$project$Main$CountryDetails = F2(
	function (country, region) {
		return {country: country, region: region};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$countryDetailsDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$CountryDetails,
...
var $author$project$Main$decodeCountries = A2(
	$elm$json$Json$Decode$field,
	'data',
	$elm$json$Json$Decode$dict($author$project$Main$countryDetailsDecoder));
...
var $author$project$Main$getRequestCountries = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotRequestCountriesResponse, $author$project$Main$decodeCountries),
		url: 'https://corsproxy.io/?https://api.first.org/data/v1/countries'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{countries: $elm$core$Dict$empty, toggle: false},
		$author$project$Main$getRequestCountries);
};
...
var $author$project$Main$deepSkyBlue = A3($mdgriffith$elm_ui$Element$rgb255, 0, 191, 255);
...
var $author$project$Main$green = A3($mdgriffith$elm_ui$Element$rgb255, 39, 203, 139);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 224, 255, 255))
			]),
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							{description: 'Talenteca', src: '/logo.ico'})
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX]),
					$mdgriffith$elm_ui$Element$text('Elm web page accessing a JSON API ')),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$padding(10),
							$mdgriffith$elm_ui$Element$Background$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 32, 178, 170))
						]),
					_List_fromArray(
						[
							A2(
							...
							$mdgriffith$elm_ui$Element$text('Toggle to change the search option')),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$text('Search by Country')),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$centerX]),
									...
									$mdgriffith$elm_ui$Element$text('Search by Name and Phone'))
								]))
						])),
					A2(
					$mdgriffith$elm_ui$Element$column,
					...
					A2(
						...
						function (_v0) {
							var _short = _v0.a;
							var country = _v0.b.country;
							var region = _v0.b.region;
							return A2(
								$mdgriffith$elm_ui$Element$row,
								_List_Nil,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(_short + (': ' + (country + ('-' + region))))
									]));
						},
						$elm$core$Dict$toList(model.countries)))
				])));
};
