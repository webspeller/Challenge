defmodule CountriesApiTest.Router do
  ...
  # This makes the conn object available in the scope of the tests,
  # which can be usd to make the HTTP request
  ...
  test "return ok" do
    ...
    conn = CountriesApi.Router.call(conn, @opts)
  ...
  doctest CountriesApi

  test "greets the world" do

    assert CountriesApi.hello() == :world
  end
end
